...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, out17_Pin|out14_Pin|out15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, out06_Pin|out04_Pin|out12_Pin|out13_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(out05_GPIO_Port, out05_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : out17_Pin out14_Pin out15_Pin */
  GPIO_InitStruct.Pin = out17_Pin|out14_Pin|out15_Pin;
  ...
  /*Configure GPIO pins : out06_Pin out04_Pin out12_Pin out13_Pin */
  GPIO_InitStruct.Pin = out06_Pin|out04_Pin|out12_Pin|out13_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
